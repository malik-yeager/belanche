...
export default function Home() {
  ...
  const latestPlaces = getSortedTripsData();
      ...
      <div className="container mx-auto px-4 pb-10">
        ...
        <div className="space-y-8 mt-12">
          ...
          <div className="flex items-center gap-6 w-full mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-heading font-black text-theme-text tracking-tight">Curated Travel Experiences</h2>
          </div>
          ...
          <div className="mt-24 mb-12">
            ...
            <div className="flex items-center gap-6 w-full mb-12">
              <h2 className="text-3xl md:text-4xl font-heading font-black text-theme-text tracking-tight uppercase">The Man Behind the Miles</h2>
              <div className="flex-1 h-1 rounded-full bg-theme-accent/50"></div>
            </div>
            ...
            <div className=" flex flex-col-reverse lg:flex-row items-center gap-12 animate-fade-in py-8 relative">
              ...
              <div className="w-full lg:w-7/12 flex flex-col justify-center">
                <div className="relative">
                  <h4 className="text-5xl md:text-6xl font-heading font-black text-theme-text mb-4 tracking-tighter">Malik</h4>
                  <p className="text-lg md:text-xl font-subheading text-theme-highlight font-bold uppercase tracking-widest mb-8">Explorer & Techie</p>
                  ...
                  <div className="text-xl md:text-2xl leading-relaxed font-subheading font-medium mb-10 max-w-3xl transparent-text-gradient bg-clip-text space-y-4">
                    ...
                    <p>
                      Whether traversing the bustling streets of Tokyo or finding serenity in the Swiss Alps, I believe every journey writes a new function in the codebase of our lives. I build scalable software systems by day, and hunt for the world's best espresso by night.
                    </p>
                  </div>
