...
const PlaceCard: React.FC<PlaceCardProps> = ({ place }) => {
    return (
        <Link href={`/place/${place.id}`} className="group relative block rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 bg-theme-surface border border-transparent hover:border-theme-highlight/20">
